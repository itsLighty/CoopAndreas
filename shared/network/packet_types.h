...
extern inline const char* ePacketType_ToString(ePacketType packetType)
{
    static constexpr const char* array[] = {"PLAYER_CONNECTED", "PLAYER_DISCONNECTED", "PLAYER_ONFOOT_UPDATE",
        ...
        "VEHICLE_PASSENGER_UPDATE", "PLAYER_CHAT_MESSAGE", "PED_SPAWN", "PED_REMOVE", "PED_ONFOOT", "GAME_WEATHER_TIME",
        "PED_ADD_TASK", "PED_REMOVE_TASK", "PLAYER_KEY_SYNC", "PED_DRIVER_UPDATE", "PED_SHOT_SYNC",
        "PED_PASSENGER_UPDATE", "PLAYER_CAMERA_SYNC", "VEHICLE_CONFIRM", "PED_CONFIRM", "PLAYER_STATS",
        "REBUILD_PLAYER", "RESPAWN_PLAYER", "ASSIGN_VEHICLE", "ASSIGN_PED", "MASS_PACKET_SEQUENCE", "START_CUTSCENE",
        "SKIP_CUTSCENE", "OPCODE_SYNC", "ON_MISSION_FLAG_SYNC", "UPDATE_ENTITY_BLIP", "REMOVE_ENTITY_BLIP",
        "ADD_MESSAGE_GXT", "REMOVE_MESSAGE_GXT", "CLEAR_ENTITY_BLIPS", "PLAY_MISSION_AUDIO", "UPDATE_CHECKPOINT",
        ...
        "GANG_WAR_STATE", "PICKUP_SPAWN", "PICKUP_STATE", "PICKUP_REMOVE", "PICKUP_COLLECT_REQUEST",
        "PICKUP_COLLECT_FORWARD", "PICKUP_COLLECT_DECISION", "PICKUP_COLLECT_RESULT", "PICKUP_SNAPSHOT_CHUNK"};

...
class VehicleAuxStateSyncTests(unittest.TestCase):
    ...
    def test_attach_before_and_after_stream_order_timeout_and_removal_cleanup(self):
        ...
        destructor = function_body(self.client_vehicle, r"CNetworkVehicle::~CNetworkVehicle\s*\(")
        self.assertIn("StreamOut();", destructor)
        stream_out = function_body(self.client_vehicle, r"CNetworkVehicle::StreamOut\s*\(")
        self.assertIn("DetachTrailerLinks();", stream_out)
